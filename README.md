...
| 🛡️ **Cyber threat watch** | Live attack sources (SANS ISC / DShield honeypots), online botnet C2 servers (abuse.ch Feodo Tracker), **ransomware victims** (ransomware.live leak-site tracking), **Tor exit nodes** (Tor Project), and vulnerabilities being **actively exploited** (CISA KEV) — as sharp 3D threat-blips, 💀/🕷️/🧅 icons and animated attack arcs, plus a transparent 0–100 threat level. |
...
| [ransomware.live](https://www.ransomware.live/) | Recent ransomware victims (dark-web leak-site aggregation) |
| [Tor Project](https://www.torproject.org/) | Live Tor exit-node list |
| [ip-api.com](https://ip-api.com/) | Geolocation of attacker/Tor IPs (keyless batch) |
